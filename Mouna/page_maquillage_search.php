...
if(isset($_POST['submit'])){
    ...
    @$search = mysqli_real_escape_string($db,$searchRec);
      if (!empty($search)) 
     { @$sqlSearch= " SELECT * FROM `produit` WHERE NomProduit='$search' AND CategorieProduit='Maquillage' ORDER BY NomProduit " ;
      ...
      <div class="row-card-contenu"> 
        ...
        <?php 
                 $existe=0;          
                      ...
                      <?php   }} if ($existe==0) echo "<div style='border:2px solid black;padding:15px;width:900px;' ><h2 >Aucun document correspondant à votre choix n'est trouvé. Veuillez réintroduire votre choix!</h2></div>";
                    }?>
