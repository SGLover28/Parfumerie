    ...
    <div class="container-fluid">
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-3">
            <div class="filtre" style="height: 2180px;margin-bottom:150px">
              ...
              <form class="form_filtre" action="page_cadeau_filtre.php" method="POST">
                ...
                <h4 style="margin-top:50px">Nb points:</h4>
                <hr color="white">
...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="col-sm-9" >
      ...
      <?php 
      $existe=0;
       if ($longCategorie==0 && $longMarque==0  && empty($max) ){
       ...
       <?php }
       } else if($longCategorie==0 && $longMarque==0 && !empty($max)){   $existe=1;

                    $produitquery= "SELECT * FROM `cadeau` WHERE nbPointCadeau <= $max ";
                    $produit=mysqli_query($db, $produitquery);
       ...
       ?>
        ...
        <?php }
         }else if ($longCategorie==0 && $longMarque>0 )
        {   for ($i= 0;$i<$longMarque;$i++) {
            if(!empty($max)) {
          $produitquery="SELECT * FROM `cadeau` WHERE NomCadeau = '$marque[$i]' AND nbPointCadeau <= $max";}
         else  $produitquery="SELECT * FROM `cadeau` WHERE NomCadeau = '$marque[$i]'";
         $produit=mysqli_query($db, $produitquery);
   ...
   <?php }
            ...
            if(!empty($max)) {
                $produitquery="SELECT * FROM `cadeau` WHERE CategorieCadeau = '$categorie[$i]' AND nbPointCadeau <= $max";}
               else  $produitquery="SELECT * FROM `cadeau` WHERE CategorieCadeau = '$categorie[$i]'";
               $produit=mysqli_query($db, $produitquery);
 ...
 <div class="column ">
   ...
   <?php }
    ...
    for ($i= 0;$i<$longMarque;$i++) {
    for ($j= 0;$j<$longCategorie;$j++) { 
    if(!empty($max)) {
        $produitquery="SELECT * FROM `cadeau` WHERE CategorieCadeau = '$categorie[$j]' AND nbPointCadeau <= $max AND  NomCadeau = '$marque[$i]'";}
       else  $produitquery="SELECT * FROM `cadeau` WHERE CategorieCadeau = '$categorie[$j]' AND  NomCadeau = '$marque[$i]'";
       $produit=mysqli_query($db, $produitquery);
  ...
  echo "<div style='padding:15px;width:900px;height:1450px' ></div>";
    }?>
  ...
  <div class="marque_nom">
    <hr style="height: 3px;margin-top:100px">
    <ul >
